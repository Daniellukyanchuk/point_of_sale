  ...
  private
    ...
    def purchase_params
      stop
        ...
        :date_expected, :date_received, :purchase_product_id, purchase_products_attributes: [:id, :product_id, :purchase_id, :purchase_quantity, :purchase_price, :purchase_subtotal, 
        :estimated_quantity, :estimated_cost, :estimated_subtotal, :_destroy])
    end
