...
# What should be the end result?  25 muffins should be taken from the oldest muffin inventory row, which is Inventory_id 1 and the next muffin row (2) should have 5 less     
...
# Step 3:   Find the smaller number between amount_left_to_remove and oldest_inventory.current_amount_left and store that as amount_to_remove amount_to_remove  25
# Step 4:   Subtract amount_to_remove from oldest_inv.current_amount_left and store it in current_amount_left oldest_inv.current_amount_left  0
