class Recipe < ApplicationRecord
  ...
  def self.get_recipe_cost(recipe_id)
      ...
      sql = """
        ...
        SELECT recipe_id, SUM(usage_cost) AS usage_cost, units, yield, cost_per_kg, recipes.product_id FROM (
            ...
            (price/(grams_per_unit/1000)) AS cost_per_kg
            FROM products
        ...
        GROUP BY recipe_id, units, yield, recipes.product_id, cost_per_kg
