...
class PurchasesTest < ApplicationSystemTestCase
  ...
  test "creating a Purchase" do
    ...
    fill_in "Actual total", with: @purchase.actual_total
    fill_in "Date of the order", with: @purchase.date_of_the_order
    fill_in "Estimated total", with: @purchase.estimated_total
    fill_in "Expected date of delivery", with: @purchase.expected_date_of_delivery
