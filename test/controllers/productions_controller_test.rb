...
class ProductionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create production" do
    assert_difference('Production.count') do
      post productions_url, params: { production: { production_quantity: @production.production_quantity, production_total_cost: @production.production_total_cost, recipe_name: @production.recipe_name } }
    end
  ...
  test "should update production" do
    patch production_url(@production), params: { production: { production_quantity: @production.production_quantity, production_total_cost: @production.production_total_cost, recipe_name: @production.recipe_name } }
